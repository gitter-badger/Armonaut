...
from armonaut.auth.services import database_login_factory, oauth_factory
...
def includeme(config):
    ...
    config.register_service_factory(oauth_factory, IOAuthService)
